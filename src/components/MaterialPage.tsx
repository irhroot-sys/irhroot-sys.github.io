...
import { ChevronRight, ShieldCheck, Factory, Recycle, ArrowRight, Zap, Anvil, Feather, Phone, Mail, CheckCircle2 } from 'lucide-react';
...
const SPEC_DATA: Record<string, {
  ...
  copper: {
    ...
    compliance: [
      "Grade and contamination review",
      "Ownership documentation review",
      "Load-specific safety screening",
  ...
  aluminum: {
    ...
    compliance: [
      "Alloy and contamination review",
      "Ownership documentation review",
      "Load-specific safety screening",
      "Written acceptance criteria"
    ],
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-12 pb-8 border-b border-zinc-200 dark:border-zinc-800/80">
          ...
          <div className="max-w-md lg:text-right">
            <div className="text-[10px] font-mono tracking-widest text-zinc-400 dark:text-zinc-500 uppercase mb-1">Pricing</div>
            <div className="text-2xl sm:text-3xl text-orange-700 dark:text-primary font-mono font-bold tracking-wider">Spot quote required</div>
            <div className="text-[9px] text-zinc-500 dark:text-zinc-400 font-mono mt-1">NON-BINDING UNTIL WRITTEN CONFIRMATION</div>
          </div>
        </div>
        ...
        <div className={`tech-card border border-zinc-200/80 dark:border-zinc-800/60 bg-zinc-50/30 dark:bg-zinc-950/20 backdrop-blur-sm p-8 rounded-sm shadow-sm mb-12 text-zinc-400/25 dark:text-zinc-700/30 ${isCopper ? 'hover:text-[#f97316]' : isSteel ? 'hover:text-[#a1a1aa]' : 'hover:text-[#38bdf8]'} ${accentGlow} transition-all duration-300`}>
          ...
          <p className="text-zinc-600 dark:text-zinc-400 mb-8 text-sm leading-relaxed max-w-3xl relative z-10">
            {data.desc} Acceptance and pricing depend on a load-specific review of grade, condition, contamination, quantity, ownership documentation, and safe handling requirements.
          </p>
        ...
        <div className={`tech-card border border-zinc-200/80 dark:border-zinc-800/60 bg-white dark:bg-zinc-950 p-8 rounded-sm shadow-lg flex flex-col lg:flex-row justify-between items-center gap-8 relative overflow-hidden text-zinc-400/25 dark:text-zinc-700/30 hover:text-primary ${accentGlow} transition-all duration-300`}>
          ...
          <div className="relative z-10 text-center lg:text-left">
            <h4 className="text-orange-700 dark:text-primary text-xs font-bold tracking-widest uppercase mb-1">Direct Spot Quoting</h4>
            <h3 className="text-zinc-900 dark:text-white text-xl sm:text-2xl font-bold tracking-wide uppercase">Request a Spot Quote</h3>
            <p className="text-zinc-500 dark:text-zinc-400 text-xs mt-1">Connect with our trading department for a load-specific, non-binding indication and written confirmation.</p>
          </div>
