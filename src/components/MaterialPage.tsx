      ...
      <div className="prose dark:prose-invert prose-zinc max-w-none text-zinc-600 dark:text-zinc-400">
        ...
        <div className="p-8 border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 shadow-sm">
          ...
          <div className="mt-6 pt-6 border-t border-zinc-200 dark:border-zinc-800">
            <a href="#contact" className="inline-flex items-center gap-2 bg-orange-700 hover:bg-orange-600 dark:bg-primary dark:hover:bg-orange-500 text-white dark:text-zinc-950 font-bold tracking-widest text-xs uppercase px-6 py-3 rounded-sm transition-colors shadow-lg">
